...
exports.config = {
    ...
    //
    // hostname: 'http://hub-cloud.browserstack.com',
    // port: 80,
    //
    // path: '/',
    //
    ...
    capabilities: browsers.filter(({os, os_version, browser, browser_version}) =>
      os === 'Windows' && browser === 'firefox' && browser_version === '44.0'),
    // capabilities: [{
    //     "os": "ios",
    //     "os_version": "11.3",
    ...
    baseUrl: 'http://noreferrer.hypnosphi.de',
    ...
    reporters: [
      ...
      ['json', {
        ...
        outputFileFormat: ({cid, capabilities}) => {
          return `${getEnviromentCombo(capabilities)}-${cid}.json`
        }
      }]
    ],
